...
L.Control.Coordinates = L.Control.extend({
	...
	onAdd: function(map) {
		...
		if (options.useLatLngOrder) {
		 ...
		 //if (options.enableUserInput) {	this._inputY = this._createInput("inputY", this._inputcontainer);};
			xSpan = L.DomUtil.create("span", "", this._inputcontainer);
	         //if (options.enableUserInput) {	this._inputX = this._createInput("inputX", this._inputcontainer);};
		} else {
			xSpan = L.DomUtil.create("span", "", this._inputcontainer);
